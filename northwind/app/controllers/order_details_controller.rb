class OrderDetailsController < ApplicationController
  ...
  def index
    @order_details = OrderDetail.find_by_id(params[:id]).page(params[:page]) if params[:id]
  end
  ...
  def create
    ...
    respond_to do |format|
      if @order_detail.save
        format.html { redirect_to '/', notice: 'Order detail was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to '/', notice: 'Order detail was successfully destroyed.' }
